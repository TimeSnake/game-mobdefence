...
public class FollowerSkeleton extends ArmorMob<ExSkeleton> {
    ...
    private ExBlaze getBlaze() {
        ...
        blaze.addPathfinderGoal(2, new ExPathfinderGoalFollowEntity(EntityClass.EntitySkeleton, 1.1f, 10, 30));
        blaze.addPathfinderGoal(3, new ExPathfinderGoalFollowEntity(EntityClass.EntitySkeleton, 1.1f, 10, 30));
        blaze.addPathfinderGoal(3, new ExPathfinderGoalFollowEntity(EntityClass.EntityBlaze, 1.1f, 10, 30));
