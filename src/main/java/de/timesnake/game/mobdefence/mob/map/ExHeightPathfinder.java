...
public class ExHeightPathfinder extends ExCustomPathfinderGoalUpdatedLocation {
  ...
  public ExHeightPathfinder(HeightMap map, int steps, double speed, double trackingDistance,
      double minDistance,
      ExPathfinderGoal breakBlock, int breakLevel) {
    super(new CorePathfinder(map, steps, speed, trackingDistance, minDistance, breakBlock,
        breakLevel));
  ...
  public static class CorePathfinder extends CustomPathfinderGoalUpdatedLocation {
    ...
    public CorePathfinder(HeightMap map, int steps, double speed, double trackingDistance,
        double minDistance,
        ExPathfinderGoal breakBlock, int breakLevel) {
