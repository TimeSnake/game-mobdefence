...
public class Speer extends CooldownWeapon {
    ...
    private static final ItemLevelType<?> FLAME = new ItemLevelType<>("Flame", new ExItemStack(Material.BLAZE_POWDER), 0, 1, ItemLevel.getLoreNumberLevels("Flame", 3, 0, "", 1, List.of(new ShopPrice(64, ShopCurrency.BRONZE)), "Flame", List.of(1)));
