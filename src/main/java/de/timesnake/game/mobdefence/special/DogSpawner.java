...
import de.timesnake.basic.entities.pathfinder.target.ExPathfinderGoalOwnerHurtByTarget;
import de.timesnake.basic.entities.pathfinder.target.ExPathfinderGoalOwnerHurtTarget;
...
public class DogSpawner extends EntitySpawner {
    ...
    private ExWolf getDog(User user) {
        ...
        entity.addPathfinderGoal(3, new ExPathfinderGoalHurtByTarget(EntityClass.EntityHuman, EntityClass.EntitySheep, EntityClass.EntityIronGolem, EntityClass.EntitySnowman));
